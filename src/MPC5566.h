/**************************************************************************/
/* FILE NAME: mpc5566.h                      COPYRIGHT (c) Freescale 2007 */
...
/* 1.3   S. Mathieson   30/Aug/06    SPR: L1SCR0, updated bit name from   */
/*                                   DPP to DPB to align with             */
/*                                   documentation.                       */
...
#define CAN_D     (*( struct FLEXCAN2_tag *)  0xFFFCC000)

#define FEC     (*( struct FEC_tag *)  0xFFF4C000)
