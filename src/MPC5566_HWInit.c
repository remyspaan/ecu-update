...
/*
 *
 * FILE : MPC5566_HWInit.c
 *
 * DESCRIPTION:
 *  This file contains all MPC5566 derivative needed initializations, 
 *  and all initializations for the MPC5566 boards which are supported.
...
#include "MPC5566.h"        /* MPC55xx platform development header            */
#include "MPC5566_HWInit.h"
...
/*******************************************************/
/* MPC5566 derivative specific hardware initialization */
/*******************************************************/

/* Symbol L2SRAM_LOCATION is defined in the application linker command file (.lcf) 
   It is defined to the start of the L2SRAM of the MPC5566. 
*/
...
/*******************************************************/
/* MPC5566 boards specific hardware initializations    */
/*******************************************************/
...
#if INIT_USED_BOARD==MPC5566DEMO_AXM_0321
/* Symbol AXM_0321_EXTERNAL_RAM is defined in the application linker command file (.lcf) 
   It is defined to the start of the external memory on the MPC5566DEMO_AXM-0321 board 
*/
...
nofralloc
    ...
    /*  This initializes the MPC5566 external bus
        Set up the pins
